...
class TranAD(nn.Module):
	def __init__(self, feats):
		...
		decoder_layers3 = TransformerDecoderLayer(d_model=2 * feats, nhead=feats, dim_feedforward=16, dropout=0.1)
		self.transformer_decoder3 = TransformerDecoder(decoder_layers3, 1)
		self.fcn = nn.Sequential(nn.Linear(2 * feats, feats), nn.Sigmoid())
